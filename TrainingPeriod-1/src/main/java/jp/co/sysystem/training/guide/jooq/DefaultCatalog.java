...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>trainingguidebook</code>.
     */
    public final Trainingguidebook TRAININGGUIDEBOOK = Trainingguidebook.TRAININGGUIDEBOOK;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            Trainingguidebook.TRAININGGUIDEBOOK
        );
    }
