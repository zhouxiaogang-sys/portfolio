...
import jp.co.sysystem.training.guide.web.request.LoginRequest;
...
public class LoginController {
  ...
  @PostMapping("/login")
  public String loginProcess(@Validated @RequestBody LoginRequest request,
...
//      model.addAttribute("loginForm", form);
    ...
    return loginService.checkLoginUser(request.getUsername(), request.getPassword())
            .map(user -> {
